        ...
        <header className="bg-white px-8 py-6 flex justify-between items-center z-10 shrink-0 border-b border-slate-100 shadow-sm shadow-slate-100">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 ml-2 pl-6 border-l border-slate-200">
              ...
              <button onClick={() => setIsSettingsOpen(true)} className="w-10 h-10 ml-2 rounded-2xl bg-white border border-slate-200 text-slate-500 hover:bg-slate-50 hover:text-slate-800 flex items-center justify-center transition-all shadow-sm">
