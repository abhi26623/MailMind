  ...
  const toggleReadLaterMutation = api.email.toggleReadLater.useMutation({
    onSuccess: (data, variables) => {
      if (variables.isReadLater) {
        showToast("Added to Read Later", "success");
      } else {
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1.5 flex justify-between items-end min-h-[20px]">
                          ...
                          {/* Read Later Button (Bottom Right) */}
                          <button
                            ...
                            className={`p-1 rounded transition-all opacity-0 group-hover:opacity-100 ${isActive ? "text-slate-300 hover:text-white hover:bg-slate-700" : "text-slate-400 hover:text-forest-600 hover:bg-forest-50 border border-transparent hover:border-forest-200 shadow-sm"}`}
                          >
